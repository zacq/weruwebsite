...
export const metadata = {
  title: "Agriculture — Weru TV",
  description: "Farming tips, market prices, weather forecasts, and agri-business news for Kenyan farmers.",
};
    ...
    <>
      ...
      >
        ...
        <p className="text-white/50 text-sm text-center max-w-md leading-relaxed">
          Farming innovations, crop market prices, weather alerts, and agri-business stories for Kenya&apos;s farmers. Launching shortly.
        </p>
      </section>
      <Footer />
    </>
